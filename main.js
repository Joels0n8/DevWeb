function validate(output){
    ...
    if(canEnter.trim(' ') != ''){
        ...
        if(output){
            document.getElementById('cleanEntryButton').style.display = 'flex';
        }
        ...
        document.getElementById('stringEmpty').innerHTML = 'String vazia!';
        return false;
    }
...
function cleanEntry(){
    ...
    document.getElementById('stringUpper').innerHTML = '';
    document.getElementById('stringProper').innerHTML = '';
    document.getElementById('stringCapital').innerHTML = '';
    document.getElementById('stringLower').innerHTML = '';
    document.getElementById('stringMd5').innerHTML = '';
    document.getElementById('stringBase64').innerHTML = '';
    document.getElementById('stringDecodeBase64').innerHTML = '';
    document.getElementById('cleanEntryButton').style.display = 'none';
...
function md5(){
    ...
    if(validate(true)){
        ...
        document.getElementById('stringMd5').innerHTML = 'Md5: ' + result;
...
function base64(){
    ...
    if(validate(true)){
        ...
        var result = Base64.encode(string);
        document.getElementById('stringBase64').innerHTML = 'Base64: ' + result;
...
function decodeBase64(){
    ...
    if(validate(true)){
        ...
        var base64 = document.getElementById('stringBase64').textContent;

        if(base64 != ''){
            
            var string = document.getElementById('string').textContent;
            var result = Base64.decode(Base64.encode(string));
            document.getElementById('stringDecodeBase64').innerHTML = 'DecodeBase64: ' + result;

        }
        else{
            document.getElementById('stringDecodeBase64').innerHTML = 'Primeiro encode com Base64';
        }
